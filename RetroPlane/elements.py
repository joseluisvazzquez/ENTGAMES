...
class Aircraft(pygame.sprite.Sprite):
    def __init__(self):# alien_group
        ...
        self.sprites_movement = [
            pygame.transform.scale(pygame.image.load("RetroPlane/aircraft_img/avion-left.png"), (95,90)),
            pygame.transform.scale(pygame.image.load("RetroPlane/aircraft_img/avion-right.png"), (95,90))]
    
    
        self.sprites = [
            pygame.image.load("RetroPlane/aircraft_img/avion1.png"),
            pygame.image.load("RetroPlane/aircraft_img/avion2.png")
        ]
    ...
    def animate(self):
        if score >= 10 and score < 20:
            self.sprites = [
                pygame.image.load("RetroPlane/aircraft_img/player.png"),
                pygame.image.load("RetroPlane/aircraft_img/player1.png")
            ]
            self.sprites_movement = [
                pygame.transform.scale(pygame.image.load("RetroPlane/aircraft_img/player3.png"), (95,90)),
                pygame.transform.scale(pygame.image.load("RetroPlane/aircraft_img/player2.png"), (95,90))
            ]
        if score == 20:
            self.sprites = [
                pygame.image.load("RetroPlane/aircraft_img/e1.png"),
                pygame.image.load("RetroPlane/aircraft_img/e2.png")
            ]
            self.sprites_movement = [
                pygame.transform.scale(pygame.image.load("RetroPlane/aircraft_img/e4.png"), (95,90)),
                pygame.transform.scale(pygame.image.load("RetroPlane/aircraft_img/e3.png"), (95,90))
            ]
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self,x, y):
        super().__init__()
        self.image = pygame.transform.scale(pygame.image.load("RetroPlane/aircraft_img/bullet.png"), (20, 30))
        if score >= 10 and score < 13:
            self.image = pygame.transform.scale(pygame.image.load("RetroPlane/aircraft_img/avion-bullet.png"), (70, 70))
        self.rect = self.image.get_rect()
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()       
        self.image = pygame.transform.scale(pygame.image.load("RetroPlane/enemy_img/e"+ str(random.randint(1, 2))+".png"),(110, 100))
        self.rect = self.image.get_rect()
        self.rect.center = [x, y]
        self.speed = 2
        if score >= 10:
...
class EnemyBullet(pygame.sprite.Sprite):
    def __init__(self,x, y):
        super().__init__()
        self.image = pygame.transform.scale(pygame.image.load("RetroPlane/enemy_img/enemy_bullet.png"), (20, 30))
        if score >= 10:
            self.image = pygame.transform.scale(pygame.image.load("RetroPlane/aircraft_img/bullet2.png"), (20, 30))
        self.rect = self.image.get_rect()
        self.rect.center = [x, y] 
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self,x, y):
        ...
        self.images = []
        for n in range(1, 10):
            img = pygame.image.load(f"RetroPlane/explosion/Circle_explosion{n}.png")
...
class Background:
    ...
    def __init__(self) -> None:
        ...
        self.bg = pygame.image.load("RetroPlane/frame.png").convert()
    ...
    def changebg(self):
        if score == 10: 
            self.bg = pygame.image.load("RetroPlane/frame2.png").convert()
        if score == 20: 
            self.bg = pygame.image.load("RetroPlane/frame3.png").convert()